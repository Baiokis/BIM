...
namespace EzDimension.dims
{
    public class AngleDimension : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Destroy(arcGO.GetComponent<MeshCollider>());
            arcGO.name = "Arc";
        ...
        public void UpdateTextAndIndicator(Vector3 _pointA, Vector3 _pointBproxy, Vector3 _pointCProxy, Material _arcMaterial,
            ...
            float _hitNormalOffset, float _angleDimensionTextOffset)
        {
            ...
            // text local Y offset
            numberParentGO.transform.localPosition += firstPointHitNormal * _hitNormalOffset;
            // Arc parent local Y offset 
            arcParentGO.transform.localPosition += firstPointHitNormal * _hitNormalOffset;
